...
function AdminDashboard() {
    ...
    const handleSubmitForm = async (e) => {
        ...
        try {
            ...
            setFormError(
                "Failed to save package. Check the fields and try again."
            );
    ...
    const inputClass =
        "w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-600 focus:border-transparent transition";
        ...
        >
            ...
            <div className="bg-white rounded-lg p-3 border border-gray-100 flex flex-col gap-2">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <input
                        className={inputClass}
                        name="madinahCategory"
                        placeholder="Category"
                        value={formData.madinahCategory}
                        onChange={handleFormChange}
                    />
                    ...
                    <input
                        ...
                        placeholder="Distance from Haram"
                        value={formData.madinahDistance}
                        onChange={handleFormChange}
                    />
                </div>
            </div>
            ...
            {editingId && existingImages.length > 0 && (
                <div className="mt-2">
                    ...
                    <p className="text-xs text-gray-400 mb-2">
                        Tick an image to remove it when you update.
                    </p>
                    ...
                    {imagesToRemove.length > 0 && (
                        <p className="text-red-500 text-xs mt-2">
                            {imagesToRemove.length} image(s) will be removed
                            when you update.
                        </p>
                    )}
                </div>
                    ...
                    <div className="max-w-sm mb-6">
                        ...
                        >
                            ...
                            <button
                                ...
                                className="bg-emerald-900 text-white font-semibold py-2.5 rounded-xl disabled:opacity-60"
                            >
                                {passwordSubmitting
                                    ? "Updating..."
                                    : "Update Password"}
                                                ...
                                                <div className="flex flex-col md:flex-row justify-between md:items-start gap-3">
                                                    <div className="flex-1 min-w-0">
                                                        <div className="flex flex-wrap items-center gap-2 mb-1">
                                                            <span className="inline-block bg-amber-50 text-amber-700 text-xs font-bold px-2.5 py-0.5 rounded-full uppercase">
                                                                {pkg.type}
                                                            </span>
                                                            ...
                                                            {pkg.availability &&
                                                                pkg.availability !==
                                                                    "Available" && (
                                                                    <span
                                                                        className={`inline-block text-xs font-bold px-2.5 py-0.5 rounded-full uppercase ${
                                                                            pkg.availability ===
                                                                            "Sold Out"
                                                        ...
                                                        <p className="font-[Playfair_Display] font-bold text-gray-800 truncate">
                                                            {pkg.title}
                                                        </p>
